# Migration Guide (v0.x to v0.2.2)

Meridian v0.2.2 introduces structural improvements to request execution safety, distributed coordination, and the custom adapter interface. This guide details the steps to upgrade your application.
...
In v0.2.2, to support async auth strategies, token discovery, and state storage connections, you must use the static asynchronous `Meridian.create` method:
...
| Old Method (v0.x) | New Method (v0.2.2) |
|---|---|
